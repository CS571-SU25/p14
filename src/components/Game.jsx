                                        ...
                                        <Container>
                                            {
                                                nums.map((row) => <Row key={row}> {
                                                    nums.map((col) => <Col key={col}><Cell row={row} col={col + square}></Cell></Col>)
                                                }</Row>)
                                            }
                                        </Container>
                                    </Card>
                        ...
                        nums.map((square) => <Col key={square}> 
                                    <Card>
                                        <Container>
                                            {
                                                nums.map((row) => <Row key={row}> {
                                                    nums.map((col) => <Col key={col}><Cell row={row + 3} col={col + square}></Cell></Col>)
                                                }</Row>)
                                            }
                                        </Container>
                                    </Card>
                        ...
                        nums.map((square) => <Col key={square}> 
                                    <Card>
                                        <Container>
                                            {
                                                nums.map((row) => <Row key={row}> {
                                                    nums.map((col) => <Col key={col}><Cell row={row + 6} col={col + square}></Cell></Col>)
                                                }</Row>)
                                            }
                                        </Container>
                                    </Card>
