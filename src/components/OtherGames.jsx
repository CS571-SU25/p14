...
export default function OtherGames(props) {
    ...
    return <Container>
        <SudokuNavBar style={{color: "black"}}/>
        <h1 style={{marginTop: 25, color: preferences.hColor}}>Other games</h1>
        <h2 style={hStyle}>Killer Sudoku</h2>
